...
class MenuWindow(xbmcgui.WindowXML):
    ...
    def onAction(self, action):
        plugintools.log("MenuWindow.onAction action.id=" + repr(action.getId()) + " action.buttonCode=" + repr(
    ...
    def on_playback_stopped(self):
        plugintools.log("DetailWindow.on_playback_stopped currentTime=" + str(
            self.custom_player.get_current_time()) + ", totalTime=" + str(self.custom_player.get_total_time()))
